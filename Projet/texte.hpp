    constexpr const char texte[] =
    u8R"RAW(                A cheval (Gui de Maupassant)
...
Pendant quatre années encore, ce ménage, harcelé par la misère, ne connut d’autres distractions que la promenade aux Champs-Élysées, le dimanche, et quelques soirées au théâtre, une ou deux par hiver, grâce à des billets de faveur offerts par un collègue.
...
— Si on pouvait me donner un animal un peu difficile, je serais enchanté. Tu verras comme je monte ; et, si tu veux, nous reviendrons par les Champs-Élysées au moment du retour du Bois. Comme nous ferons bonne figure, je ne serais pas fâché de rencontrer quelqu’un du Ministère. Il n’en faut pas plus pour se faire respecter de ses chefs.
